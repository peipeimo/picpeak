...
## [3.103.0-beta.0](https://github.com/peipeimo/picpeak/compare/v3.102.2-beta.0...v3.103.0-beta.0) (2026-08-14)


### Features

* **accounting:** re-bill proof attachment, CRM panel & hours↔re-bills cross-add ([#979](https://github.com/peipeimo/picpeak/issues/979)) ([165cebd](https://github.com/peipeimo/picpeak/commit/165cebdb5c744cb3c3c26cc9cd4182cb5fa85143))
* admin photos list/grid toggle + upload failure report ([#707](https://github.com/peipeimo/picpeak/issues/707), [#708](https://github.com/peipeimo/picpeak/issues/708)) ([e873f7c](https://github.com/peipeimo/picpeak/commit/e873f7c98ce108b090d70a3b7df2d2929699e997))
* admin photos list/grid toggle + upload failure report ([#707](https://github.com/peipeimo/picpeak/issues/707), [#708](https://github.com/peipeimo/picpeak/issues/708)) ([6f95796](https://github.com/peipeimo/picpeak/commit/6f95796b7c19829197eaff0d4934ad9b84d0e2f3))
* admin two-factor authentication (TOTP) with recovery codes + CLI reset ([cf07361](https://github.com/peipeimo/picpeak/commit/cf073615effa8a91e19374ad3e9924e6e7322950))
* admin-configurable workflow engine + dunning/Mahngebühr rework (RFC — feedback welcome) ([15be3b8](https://github.com/peipeimo/picpeak/commit/15be3b8d32965eedc08d46ccc525c65a3bf34de6))
* **admin-ui:** TOTP MFA enrollment + two-step login; remove stub 2FA toggle ([96e3c68](https://github.com/peipeimo/picpeak/commit/96e3c68b9d6b35a82abcad664a6da7b19150b4fd))
* **admin:** GitHub repo button in the sidebar footer ([#778](https://github.com/peipeimo/picpeak/issues/778)) ([279e047](https://github.com/peipeimo/picpeak/commit/279e0472c71c6a37ba091a9c7a31f5571c0a8df6))
* **admin:** GitHub repo button in the sidebar footer ([#778](https://github.com/peipeimo/picpeak/issues/778)) ([d3d7df4](https://github.com/peipeimo/picpeak/commit/d3d7df46f214028ba89063079d356bc0430083f5))
* **admin:** in-app migration banner for the org rename ([0213347](https://github.com/peipeimo/picpeak/commit/02133478bd2684c562d11cc122cf5059832ff76a))
* **admin:** in-app migration banner for the org rename ([#669](https://github.com/peipeimo/picpeak/issues/669)) ([2a4bf3b](https://github.com/peipeimo/picpeak/commit/2a4bf3b868c6733d0b865c8c0e977ba84d6e6453))
* **admin:** surface the registry move through the update check ([#993](https://github.com/peipeimo/picpeak/issues/993)) ([137a42f](https://github.com/peipeimo/picpeak/commit/137a42f259692999fe88b75bbe6652d34893ef11))
* **analytics:** pluggable trackers — Umami + Rybbit + Custom ([#663](https://github.com/peipeimo/picpeak/issues/663) Phase 1) ([83461fe](https://github.com/peipeimo/picpeak/commit/83461fe5d4d44006482167464d92e70546cf7377))
* **analytics:** pluggable trackers — Umami + Rybbit + Custom ([#663](https://github.com/peipeimo/picpeak/issues/663) Phase 1) ([ab50145](https://github.com/peipeimo/picpeak/commit/ab501459a4208c3a30637a31f0f6f31285ae5ef2))
* **auth:** admin TOTP MFA — enrollment, login challenge, recovery, CLI reset ([72e2ef6](https://github.com/peipeimo/picpeak/commit/72e2ef6721b0572ed34455de901aa357eacd8c76))
* **auth:** OIDC logout-to-IdP — phase 3 ([#798](https://github.com/peipeimo/picpeak/issues/798)) ([#865](https://github.com/peipeimo/picpeak/issues/865)) ([219d07b](https://github.com/peipeimo/picpeak/commit/219d07b04adf54756317d3cc3069f834aa2b460e))
* **auth:** OIDC role mapping + login policy — phase 2 ([#798](https://github.com/peipeimo/picpeak/issues/798)) ([#854](https://github.com/peipeimo/picpeak/issues/854)) ([f8a95d2](https://github.com/peipeimo/picpeak/commit/f8a95d29d2feb5f651ff6a0bcfa1b5b1540f114a))
* **auth:** OIDC SSO for admin users — phase 1 ([f12606b](https://github.com/peipeimo/picpeak/commit/f12606b4e0d2fbe4f2f57a345b393448063d6614))
* **auth:** OIDC SSO for admin users — phase 1 ([#798](https://github.com/peipeimo/picpeak/issues/798)) ([ed5fc5a](https://github.com/peipeimo/picpeak/commit/ed5fc5ad5c468c638aba9e71b8665ab2dccb679a))
* **backup:** .picpeak download + upload-restore UI in Backup Manager ([66d61c8](https://github.com/peipeimo/picpeak/commit/66d61c87cad1ac1994d61e81c8c06739aa0cb8c5))
* **backup:** .picpeak import/restore (full override, keeps current account) ([2920d82](https://github.com/peipeimo/picpeak/commit/2920d82186d16d43674703d09370aeecec6a0da0))
* **backup:** .picpeak portable export (engine-neutral logical snapshot) ([38b3aef](https://github.com/peipeimo/picpeak/commit/38b3aef63d0d4f0878eddeb93f16319ef87f2372))
* **backup:** fold .picpeak restore into the Restore wizard's Upload source ([86324e7](https://github.com/peipeimo/picpeak/commit/86324e7da75069e61686b1b77495f02c33b12e1a))
* **backup:** upload + restore endpoint for .picpeak ([2b66f6d](https://github.com/peipeimo/picpeak/commit/2b66f6d889f94848202faf02116efa94ade9bd12))
* **categories:** per-event category ordering — global default + override ([#782](https://github.com/peipeimo/picpeak/issues/782)) ([d51112e](https://github.com/peipeimo/picpeak/commit/d51112e761d2fd83f1939841fbf4c05e625fc34d))
* **categories:** per-event category ordering — global default + override ([#782](https://github.com/peipeimo/picpeak/issues/782)) ([4698402](https://github.com/peipeimo/picpeak/commit/4698402b5493cfbdb1e2b6d81c6f58829e17a703))
* **crm:** 3-reminder dunning + flat/percent Mahngebühr on 2nd & 3rd + AGB notice ([dcdbeb9](https://github.com/peipeimo/picpeak/commit/dcdbeb9cc50a888ff66e65c62597fcc84c2c8f17))
* **crm:** event-type dropdown on quotes; quote→event uses it (no more hardcoded 'wedding') ([f78671f](https://github.com/peipeimo/picpeak/commit/f78671fc6c8d234be4dee87b45aae9d280a3a6f7))
* **crm:** Mahngebühr on a separate Mahnung document; invoice stays immutable ([5ed2fec](https://github.com/peipeimo/picpeak/commit/5ed2fec2fe5cd5c2c8db6ea83c3b791313618e0f))
* **crm:** pre-event reminder falls back to the assigned customer account ([3ccaed0](https://github.com/peipeimo/picpeak/commit/3ccaed06a226cdc4a18399f8daa9b2d420e3684b))
* **crm:** toggle for VAT on late fees (jurisdiction-dependent) ([eaceb7e](https://github.com/peipeimo/picpeak/commit/eaceb7e71caa6466d8298c0fc84487f0f4af1dca))
* **dashboard:** revenue "year" tile toggles 365 days ↔ calendar YTD ([d1c9e02](https://github.com/peipeimo/picpeak/commit/d1c9e02bcf50b6c08eebc85acdbfba29bfee84ac))
* **downloads:** per-gallery download resolutions ([#858](https://github.com/peipeimo/picpeak/issues/858)) ([#1022](https://github.com/peipeimo/picpeak/issues/1022)) ([8e35737](https://github.com/peipeimo/picpeak/commit/8e3573788b1bde8768d023e779ea3361c91f6223))
* **events:** gallery QR code + printable table-card/poster PDFs ([#847](https://github.com/peipeimo/picpeak/issues/847)) ([60cdd07](https://github.com/peipeimo/picpeak/commit/60cdd07085c750cee358cbe59420668cbc538473))
* **feedback:** emoji reactions on photos ([#839](https://github.com/peipeimo/picpeak/issues/839)) ([#855](https://github.com/peipeimo/picpeak/issues/855)) ([3d6c984](https://github.com/peipeimo/picpeak/commit/3d6c9848dcbace1d1ce74890460e369854be65c7))
* **feedback:** let guests remove their star rating ([#884](https://github.com/peipeimo/picpeak/issues/884)) ([#893](https://github.com/peipeimo/picpeak/issues/893)) ([6a048d0](https://github.com/peipeimo/picpeak/commit/6a048d08bd5d1d16f5ec2d2e580831086a32c71b))
* **feedback:** per-guest favorite + like caps with mobile-friendly limit modal ([#655](https://github.com/peipeimo/picpeak/issues/655)) ([3ac7017](https://github.com/peipeimo/picpeak/commit/3ac70177efc237b8169278208983b0de3629bc72))
* **feedback:** per-guest favorite + like caps with mobile-friendly limit modal ([#655](https://github.com/peipeimo/picpeak/issues/655)) ([f2814e4](https://github.com/peipeimo/picpeak/commit/f2814e4a4ce3aa9affc232243d615a15a1aae0c0))
* first-run setup wizard (feature selection + config) and portable .picpeak backup roundtrip ([e513e83](https://github.com/peipeimo/picpeak/commit/e513e8345b73e37ebedc9c9ec09665ffc5773e23))
* **gallery:** admin preview skips the password on protected galleries ([#981](https://github.com/peipeimo/picpeak/issues/981)) ([f006615](https://github.com/peipeimo/picpeak/commit/f00661511c3f3b4fc338be860965244b0ee3b611))
* **gallery:** branded URL shortener — /s/&lt;slug&gt; with OG injection ([#699](https://github.com/peipeimo/picpeak/issues/699)) ([a0f7033](https://github.com/peipeimo/picpeak/commit/a0f7033ffc812f92d56e2eac7bd2f498b95ef83b))
* **gallery:** branded URL shortener — /s/&lt;slug&gt; with OG injection ([#699](https://github.com/peipeimo/picpeak/issues/699)) ([56c2386](https://github.com/peipeimo/picpeak/commit/56c2386c90a090ee1e7f44a51328fc1291fe323f))
* **gallery:** mouse-wheel zoom at cursor in the lightbox ([#885](https://github.com/peipeimo/picpeak/issues/885)) ([#927](https://github.com/peipeimo/picpeak/issues/927)) ([926a4a5](https://github.com/peipeimo/picpeak/commit/926a4a540d6f6a1e134ca4e611f850edf6338378))
* **gallery:** multi-select feedback filters + sort direction controls ([#889](https://github.com/peipeimo/picpeak/issues/889)) ([#929](https://github.com/peipeimo/picpeak/issues/929)) ([3bcded7](https://github.com/peipeimo/picpeak/commit/3bcded78a448f5b099e87a73c7f1e44e859882aa))
* **gallery:** per-event toggle to hide the logo on the password page ([#894](https://github.com/peipeimo/picpeak/issues/894)) ([#928](https://github.com/peipeimo/picpeak/issues/928)) ([08ff9f2](https://github.com/peipeimo/picpeak/commit/08ff9f20e73a12bc89fad539781c4f48972f48e1))
* **gallery:** publish notifies assigned customer accounts via the account email ([c657892](https://github.com/peipeimo/picpeak/commit/c657892bc87f44e854827cb8a65f87cc528a2f71))
* **gallery:** quick return from zoomed to fit-to-screen in the lightbox ([#886](https://github.com/peipeimo/picpeak/issues/886)) ([#891](https://github.com/peipeimo/picpeak/issues/891)) ([97f6889](https://github.com/peipeimo/picpeak/commit/97f68899a221e3bc9b4e30c7d9a19eb16f062ba6))
* **gallery:** reveal mode — hide gallery from guests until reveal ([#838](https://github.com/peipeimo/picpeak/issues/838)) ([#856](https://github.com/peipeimo/picpeak/issues/856)) ([2f05fcc](https://github.com/peipeimo/picpeak/commit/2f05fcc39deaf226a6cc8796ebee9b40bc89e9ae))
* **invoices:** configurable VAT note under MwSt. line + fix multi-page page-number overlap ([#794](https://github.com/peipeimo/picpeak/issues/794)) ([ffd4a7e](https://github.com/peipeimo/picpeak/commit/ffd4a7eee64b6418df1c9cc6843d86dc0f41d2ec))
* **invoices:** configurable VAT/free-text note + fix multi-page page-number overlap ([#794](https://github.com/peipeimo/picpeak/issues/794)) ([1476884](https://github.com/peipeimo/picpeak/commit/1476884dd04202f5f18d50d458b6176b0535c71b))
* **invoices:** optional sub-cent rounding reconciliation ("Rundung" row) ([4670292](https://github.com/peipeimo/picpeak/commit/4670292139bf4c5ad523646f38b98b9d47ab3430))
* **invoices:** surface monthly/manual accumulator drafts in the Bills list ([e457656](https://github.com/peipeimo/picpeak/commit/e457656b9d06bb420c9d0985fe15c30d6c88aed9))
* Live Slideshow ("Diashow") — fullscreen, auto-updating projector view for live events ([4356393](https://github.com/peipeimo/picpeak/commit/4356393b4433dd6b4147388688766b9464294c89))
* **messages:** create/select quote, contract, invoice, gallery from a message ([0dbf863](https://github.com/peipeimo/picpeak/commit/0dbf863f60b919560b766f78b107ebac9612bd9d))
* **messages:** Outlook-style Messages email client (3 phases, flag-gated) ([d0bdcb1](https://github.com/peipeimo/picpeak/commit/d0bdcb1a6afd0f227d468adc35c23bb88410a578))
* **messages:** Phase 1 read-only Messages viewer (email client shell) ([26eeb76](https://github.com/peipeimo/picpeak/commit/26eeb7619703ffe0b29653e409beecd30263bcb0))
* **messages:** Phase 2 — customer (hello@) mailbox + inbound body capture ([ee46cf2](https://github.com/peipeimo/picpeak/commit/ee46cf2125c2721c3cecee8761490652552a2f2a))
* **messages:** Phase 3 — editable-template composer, reply + create actions ([768e847](https://github.com/peipeimo/picpeak/commit/768e84711f3362069d7ce6867e63c727d2009a46))
* **messages:** search bar + Archive/Delete with Archived & Deleted folders ([99d5996](https://github.com/peipeimo/picpeak/commit/99d5996561a2dcff2d431692d5bab5c7286d1f6f))
* **messages:** unified Messages email client (flag-gated, default off) ([a71b9b5](https://github.com/peipeimo/picpeak/commit/a71b9b5ed721df17b61062ae3a2361d448c95cf7))
* **notifications:** surface guest activity in the admin bell ([#849](https://github.com/peipeimo/picpeak/issues/849)) ([cb5b319](https://github.com/peipeimo/picpeak/commit/cb5b319f1022655fbc1e442d0d1e6d8337f0e637))
* **security:** harden .picpeak restore robustness — sessions, roles, sequences ([a77c2c2](https://github.com/peipeimo/picpeak/commit/a77c2c2c573a79f0194ff2b911acaa5f46c11f26))
* **security:** harden .picpeak restore robustness — sessions, roles, sequences ([340d91b](https://github.com/peipeimo/picpeak/commit/340d91bdd53a595694edfa6f3d691b240a2babcd))
* setup wizard + argument-driven unattended install ([681619f](https://github.com/peipeimo/picpeak/commit/681619f0a14070309342a9f908a5bbc8a57d47d8))
* **setup:** add "How will you use PicPeak?" feature-selection step ([422dfe1](https://github.com/peipeimo/picpeak/commit/422dfe1cc88ae277dc170e95b4746e507c31b23a))
* **setup:** add restore-from-backup branch to the first-run wizard ([a95ee47](https://github.com/peipeimo/picpeak/commit/a95ee473ae7fb2bf3c94c610724476701145d113))
* **setup:** brand first-run screen and split into two-step wizard ([d9b0eb7](https://github.com/peipeimo/picpeak/commit/d9b0eb723295c20e80c0e633ebcdb6e191528607))
* **setup:** event-types step in first-run wizard + un-hardcode event type dependencies ([109aba8](https://github.com/peipeimo/picpeak/commit/109aba859820bf80440d056baf183ecf2657fee3))
* **setup:** event-types step in first-run wizard + un-hardcode event type deps ([#800](https://github.com/peipeimo/picpeak/issues/800)) ([7eb6357](https://github.com/peipeimo/picpeak/commit/7eb6357b4a9bf3914674a63afa386a5fcf8c2161))
* **setup:** final community step ([#732](https://github.com/peipeimo/picpeak/issues/732)) + fix create-admin button overflow ([#730](https://github.com/peipeimo/picpeak/issues/730)) ([a5f49e3](https://github.com/peipeimo/picpeak/commit/a5f49e32350564ee4d3894f33e9611e9244cc994))
* **setup:** final community/thank-you step ([#732](https://github.com/peipeimo/picpeak/issues/732)); fix create-admin button overflow ([#730](https://github.com/peipeimo/picpeak/issues/730)) ([dadaaee](https://github.com/peipeimo/picpeak/commit/dadaaeea7781cb62811256b512003e5c4d6ad95e))
* **setup:** per-feature config step after feature selection ([07b450a](https://github.com/peipeimo/picpeak/commit/07b450a954a53781d23a71749552e4101c637777))
* **setup:** step-by-step wizard + argument-driven unattended install ([d35c413](https://github.com/peipeimo/picpeak/commit/d35c413651bc10f177a683a8057ad92c03b1cf00))
* **setup:** validate setup token at step 1 before advancing ([b0912c7](https://github.com/peipeimo/picpeak/commit/b0912c74276ad2489a8d199739d6eee2e8dabf53))
* **slideshow:** guest-scannable share-link QR overlay ([#848](https://github.com/peipeimo/picpeak/issues/848)) ([e8dad4b](https://github.com/peipeimo/picpeak/commit/e8dad4b40ddb816cc2f9a94be456f793adce20d7))
* **slideshow:** per-event play order + category filter ([#202](https://github.com/peipeimo/picpeak/issues/202)) ([5467642](https://github.com/peipeimo/picpeak/commit/54676424f2f7ed50e74cb8e144cbdaa5a96e65c3))
* **slideshow:** per-event play order + category filter ([#202](https://github.com/peipeimo/picpeak/issues/202)) ([b768a53](https://github.com/peipeimo/picpeak/commit/b768a53c5be577bf0ed537b0876090b3f1c4a32b))
* **transfers:** add PicTransfer — cross-event file transfers ([#998](https://github.com/peipeimo/picpeak/issues/998)) ([2e495d7](https://github.com/peipeimo/picpeak/commit/2e495d7c489c3195c6e1c042ec4ac35fe90cf4ba))
* **updates:** "What's New" highlights after update + pre-update teaser ([a1a73bf](https://github.com/peipeimo/picpeak/commit/a1a73bf75ff3fcd0833fdf7922a35ad09f19439b))
* **updates:** "What's New" highlights after update + pre-update teaser ([500cf85](https://github.com/peipeimo/picpeak/commit/500cf8522e556575bd74d4c71d38a83fb2596b5e))
* **uploads:** DNG / camera-RAW support via embedded-preview extraction ([#821](https://github.com/peipeimo/picpeak/issues/821)) ([8c260c4](https://github.com/peipeimo/picpeak/commit/8c260c4eebedb69f349505d0befbbb5afb182b2c))
* **uploads:** DNG / camera-RAW support via embedded-preview extraction ([#821](https://github.com/peipeimo/picpeak/issues/821)) ([be2ec0a](https://github.com/peipeimo/picpeak/commit/be2ec0a4a1d03045c17c2a29e7fb8616f9de65f2))
* **uploads:** HEIC/HEIF support + dynamic format hint on guest upload ([#821](https://github.com/peipeimo/picpeak/issues/821)) ([ee9d2f7](https://github.com/peipeimo/picpeak/commit/ee9d2f70d3342d65edb795a688f0f5f611429964))
* **uploads:** HEIC/HEIF support + dynamic format hint on guest upload ([#821](https://github.com/peipeimo/picpeak/issues/821)) ([2b5b23b](https://github.com/peipeimo/picpeak/commit/2b5b23b96fb819d090c0a23fcffa69c35257b394))
* **whatsapp:** admin-selectable template parameters + reorder ([#647](https://github.com/peipeimo/picpeak/issues/647) follow-up) ([80e8ec5](https://github.com/peipeimo/picpeak/commit/80e8ec5bc71f0653d56f1087521f5207aee0ba8f))
* **whatsapp:** admin-selectable template parameters + reorder ([#647](https://github.com/peipeimo/picpeak/issues/647) follow-up) ([16055cd](https://github.com/peipeimo/picpeak/commit/16055cdc413f0aa560c2b2a792b4e2ae8f5cbfd3))
* **workflows:** 'Clean up layout' auto-arrange button (dagre) ([79607c5](https://github.com/peipeimo/picpeak/commit/79607c597af07ca5b78a689469c3ffefc3699317))
* **workflows:** add workflows feature flag + Features-tab toggle ([ff47861](https://github.com/peipeimo/picpeak/commit/ff478619b580096d4dfb46dd6ad751daead082fb))
* **workflows:** admin CRUD + run-history + approvals-inbox API ([1a0d6de](https://github.com/peipeimo/picpeak/commit/1a0d6de04d3547ca0e34833befea200c2750e859))
* **workflows:** admin review gates before sends + migrate lifecycle/time triggers ([fa7b1ba](https://github.com/peipeimo/picpeak/commit/fa7b1bae951222de506ab8a3c8aee158b471efd1))
* **workflows:** advanced text mode — export/import the flow as JSON ([289568f](https://github.com/peipeimo/picpeak/commit/289568fd52fcf0f33a959f074d215853ae37e48c))
* **workflows:** approval gates — email confirm/deny + token resume ([b48d8c2](https://github.com/peipeimo/picpeak/commit/b48d8c2eb8e278d3dad8a8afef221a640bcac919))
* **workflows:** booking cutover — wire booking actions + hold documents behind approval gates ([ec33ec7](https://github.com/peipeimo/picpeak/commit/ec33ec7670a4feb1108d1bcbfe34727f63cc8cf9))
* **workflows:** collections-handoff block after dunning exhausts ([b78bd97](https://github.com/peipeimo/picpeak/commit/b78bd979dc4856a78d2022783537b8efd1297d27))
* **workflows:** crash recovery — resume runs orphaned mid-flow ([192d2cb](https://github.com/peipeimo/picpeak/commit/192d2cbc06a0295dbfdc35f05d192ae7ed5273e6))
* **workflows:** data-touching action + condition handlers ([96fb440](https://github.com/peipeimo/picpeak/commit/96fb44045e49c4cbc9b221780f7c725f80751993))
* **workflows:** emit lifecycle events from invoice + quote services ([cc0ba53](https://github.com/peipeimo/picpeak/commit/cc0ba5347d36161e3da2eaff3a1f2d56c582c4a5))
* **workflows:** execution engine core + registry + tests ([1eaef67](https://github.com/peipeimo/picpeak/commit/1eaef67c36a1a1eae6d574d2d44f2a3bdfb43d4c))
* **workflows:** hard cutover of gallery-expiry + dunning + pre-event to flows ([0b6c33e](https://github.com/peipeimo/picpeak/commit/0b6c33e59a2e1ba15210645a65800543eaf6305b))
* **workflows:** implement prepare_event so booking_full/booking_simple are enableable ([4faf5a3](https://github.com/peipeimo/picpeak/commit/4faf5a344a8d6d03cd9f374e093cc9bd8317fa48))
* **workflows:** implement remaining stub actions (prepare_quote, prepare_gallery, reserve_date) ([9414b42](https://github.com/peipeimo/picpeak/commit/9414b42b7fae9f5447c1879e9b2c34d05f7c888d))
* **workflows:** invoice prepared+approved early, dispatch waits; daysBefore in editor; dashboard approvals ([182e655](https://github.com/peipeimo/picpeak/commit/182e655fcf0fa119714e6fd34cad5f33d0087045))
* **workflows:** make approval rows clickable to open the underlying document ([7727b67](https://github.com/peipeimo/picpeak/commit/7727b6714b5654bab067b041ca9c33cf7d9270ab))
* **workflows:** migrate the dunning ladder onto the engine (cutover) ([5259ee9](https://github.com/peipeimo/picpeak/commit/5259ee97053386a63e7bcdf2a5cae22842e5ceaa))
* **workflows:** per-quote booking-workflow picker + quote→invoice (no gallery) built-in ([d14f1d8](https://github.com/peipeimo/picpeak/commit/d14f1d850cc995b2cb1119ba0424f123feba50ec))
* **workflows:** pre-event reminder picks the template GROUP on the block, type stays automatic ([10d091b](https://github.com/peipeimo/picpeak/commit/10d091b55e0c44738b4001a71def6416a8f0aeb0))
* **workflows:** React Flow canvas editor + list + approvals UI ([5c0396d](https://github.com/peipeimo/picpeak/commit/5c0396d0c1bf69ba48b42eacc6d8f145b901a299))
* **workflows:** route webhook node through the delivery pipeline (full Option 1) ([675e41a](https://github.com/peipeimo/picpeak/commit/675e41a2f72c8c23fa5c36b13bc6b95abcb9d570))
* **workflows:** scheduler resumes elapsed wait nodes ([610a3df](https://github.com/peipeimo/picpeak/commit/610a3dfd732fbf37c68bc3edacaed6c99610a2ab))
* **workflows:** schema + permissions (migration 142) ([c818c25](https://github.com/peipeimo/picpeak/commit/c818c25cf2d7a9c9b281107a92528d5923758ab0))
* **workflows:** seed booking + pre-event built-ins, wire event.date_approaching ([62ba905](https://github.com/peipeimo/picpeak/commit/62ba905464387784be7710610a65341569b68e46))
* **workflows:** seed invoice-dunning ladder as an editable built-in flow ([9b557ef](https://github.com/peipeimo/picpeak/commit/9b557efbf347ba585ceac61cfc0b6b3038ef7de6))
* **workflows:** test-fire — safe dry-run of any flow on demand ([e70ddd3](https://github.com/peipeimo/picpeak/commit/e70ddd36b8e9558dc44fc118277539fe6e7425d7))
* **workflows:** warn when disabling a built-in (reverts to legacy, not off) ([c5f131c](https://github.com/peipeimo/picpeak/commit/c5f131cec32826331722ef3705c5f5422e31726d))
* **workflows:** wire booking document actions (prepare_invoice/contract + send_document) ([cf424ef](https://github.com/peipeimo/picpeak/commit/cf424efb4a3a5e0df3a4bb1c753ca24368446816))
* zero-config first run — in-browser admin bootstrap + auto-generated secrets ([bafc96f](https://github.com/peipeimo/picpeak/commit/bafc96f468e3b5cca2ec3291e7b568886755099d))
* zero-config first run — in-browser admin bootstrap + auto-generated secrets ([415bffa](https://github.com/peipeimo/picpeak/commit/415bffa04cd82ea16c1803b67ee432a9ebd4165e))


### Bug Fixes

* **accounting:** gate cross-add counters on the permission their endpoint checks ([#984](https://github.com/peipeimo/picpeak/issues/984)) ([4b53b64](https://github.com/peipeimo/picpeak/commit/4b53b64277a6e3b1d3e94b8cc3bb705aa33629ec))
* **admin:** code-review follow-ups on [#910](https://github.com/peipeimo/picpeak/issues/910)/[#916](https://github.com/peipeimo/picpeak/issues/916) (MIME resolver + expiry reactivity) ([#921](https://github.com/peipeimo/picpeak/issues/921)) ([252475f](https://github.com/peipeimo/picpeak/commit/252475fce2ce8d5e16915c4d3558576ad720189b))
* **admin:** expose view/download counters in the admin photos list ([#895](https://github.com/peipeimo/picpeak/issues/895) follow-up) ([#914](https://github.com/peipeimo/picpeak/issues/914)) ([aca3c8e](https://github.com/peipeimo/picpeak/commit/aca3c8e4bc33e74c81c4d2f2a15baf490c967134))
* **admin:** serve videos with their real MIME type in the admin photo view ([#908](https://github.com/peipeimo/picpeak/issues/908)) ([#910](https://github.com/peipeimo/picpeak/issues/910)) ([67c56c5](https://github.com/peipeimo/picpeak/commit/67c56c5b61fc9a25f5d0b7346fb042211bc1d1de))
* **admin:** stack publish-gallery dialog CTAs so the German label fits ([#670](https://github.com/peipeimo/picpeak/issues/670)) ([748af98](https://github.com/peipeimo/picpeak/commit/748af98f3d3f8c00695b82e94d741a0e10a39a81))
* **admin:** stack publish-gallery dialog CTAs so the German label fits ([#670](https://github.com/peipeimo/picpeak/issues/670)) ([ea2852d](https://github.com/peipeimo/picpeak/commit/ea2852dcb0a0f00318a2c8067405630bcff4eee6))
* **admin:** stop marking events expired up to 24h early ([#909](https://github.com/peipeimo/picpeak/issues/909)) ([#916](https://github.com/peipeimo/picpeak/issues/916)) ([487f55f](https://github.com/peipeimo/picpeak/commit/487f55f2d9463d85898555472cd66ae69d1d0f31))
* **admin:** stop the event-date field crashing the page on backspace ([760a201](https://github.com/peipeimo/picpeak/commit/760a201b6070a4edfe8192bcddce948c5f0c3fec))
* **admin:** stray literal "0" rendered from SQLite integer booleans ([760c3d7](https://github.com/peipeimo/picpeak/commit/760c3d7b67963105f155a43297f165b7e672b074))
* **analytics:** admin dashboard reads correct fields + Umami device API ([#661](https://github.com/peipeimo/picpeak/issues/661)) ([349f566](https://github.com/peipeimo/picpeak/commit/349f566e87b33c59f61eb28b8abc5f889e6285d6))
* **analytics:** admin dashboard reads correct fields + Umami device API ([#661](https://github.com/peipeimo/picpeak/issues/661)) ([7534447](https://github.com/peipeimo/picpeak/commit/7534447b6c0df4290fd8dac12270673097096f1b))
* **analytics:** make per-photo view/download counters actually count ([#895](https://github.com/peipeimo/picpeak/issues/895)) ([#904](https://github.com/peipeimo/picpeak/issues/904)) ([78116e2](https://github.com/peipeimo/picpeak/commit/78116e2e8bf681c5483f06e9b1490dc8239e8576))
* **auth:** fail closed when the adminAuth roles join errors ([#974](https://github.com/peipeimo/picpeak/issues/974)) ([6699855](https://github.com/peipeimo/picpeak/commit/6699855c931657c7af7860e9bdd097da303a3a26))
* **auth:** issuer-tag the oversize SSO logout marker ([#798](https://github.com/peipeimo/picpeak/issues/798)) ([#1010](https://github.com/peipeimo/picpeak/issues/1010)) ([a607cea](https://github.com/peipeimo/picpeak/commit/a607cea11018e68aea8797160dbde7f34b8eca44))
* auto-publish release-please PRs without manual approval ([fb64ec0](https://github.com/peipeimo/picpeak/commit/fb64ec0910f8c3ecffb40d85e4f3a08f73503671))
* **backup:** address .picpeak review — table filter, superuser guard, tests ([fa7665c](https://github.com/peipeimo/picpeak/commit/fa7665c5b1ad18a4db4f0b59eb4c197a3c9a36e2))
* **backup:** make .picpeak roundtrip work on Postgres ([f57462f](https://github.com/peipeimo/picpeak/commit/f57462f7984c64356a9f8acb63c7df3f93909e6e))
* **backup:** make backup settings actually apply ([#871](https://github.com/peipeimo/picpeak/issues/871)) ([#874](https://github.com/peipeimo/picpeak/issues/874)) ([a2e7234](https://github.com/peipeimo/picpeak/commit/a2e723413e64819f0d8c0c03636ed04af42a47e4))
* **branding+whatsapp:** preserve customCss through preset switches ([#645](https://github.com/peipeimo/picpeak/issues/645)) + admin-pinned WhatsApp template language ([#647](https://github.com/peipeimo/picpeak/issues/647)) ([cde028e](https://github.com/peipeimo/picpeak/commit/cde028e9199a9ddb09957a87590732f4bd4d7a7b))
* **branding:** hide "Powered by PicPeak" on every page, not only the gallery ([#999](https://github.com/peipeimo/picpeak/issues/999)) ([3bb4f1a](https://github.com/peipeimo/picpeak/commit/3bb4f1a1a894a6bbc4b1610c3585b73e38f1753d))
* **branding:** make 'Show logo in hero' a true global toggle with per-event override ([#756](https://github.com/peipeimo/picpeak/issues/756)) ([a88da99](https://github.com/peipeimo/picpeak/commit/a88da99c8d35c0c7cb7f96a235e984edad74ac7c))
* **branding:** make 'Show logo in hero' a true global toggle with per-event override ([#756](https://github.com/peipeimo/picpeak/issues/756)) ([96fe478](https://github.com/peipeimo/picpeak/commit/96fe478bf87a3350185206b3d6f15133138b995d))
* **branding:** preserve customCss through preset switches + theme changes ([#645](https://github.com/peipeimo/picpeak/issues/645)) ([7cf2679](https://github.com/peipeimo/picpeak/commit/7cf26795ec12845743a30d48956381f25c6e181c))
* **branding:** route the gallery footer through &lt;PoweredBy /&gt; ([#1008](https://github.com/peipeimo/picpeak/issues/1008)) ([1bf19a7](https://github.com/peipeimo/picpeak/commit/1bf19a7caf45b7f800b3650b2cd2365ea89cb169))
* **branding:** unify hero logo SIZE the same way as visibility ([#756](https://github.com/peipeimo/picpeak/issues/756)) ([60b03b1](https://github.com/peipeimo/picpeak/commit/60b03b17287539b3ad5e5d32f4eda8622f0575e4))
* **categories:** address PR [#790](https://github.com/peipeimo/picpeak/issues/790) review — event ownership, migration renumber, nits ([a4b4485](https://github.com/peipeimo/picpeak/commit/a4b4485d322514690c5400ca7ab9a91bc25c3e48))
* **ci:** auto-publish release-please PRs without manual approval ([#719](https://github.com/peipeimo/picpeak/issues/719)) ([a3e7232](https://github.com/peipeimo/picpeak/commit/a3e7232b8ed012b8449a76d3e4ea3c5daddd5514))
* **ci:** enable release-PR auto-merge with the PAT, not GITHUB_TOKEN ([e08a33d](https://github.com/peipeimo/picpeak/commit/e08a33d9ea273dc18877743f71f59d64bfc3dfb5))
* **ci:** publish v-prefixed image tags so :vX.Y.Z resolves ([#668](https://github.com/peipeimo/picpeak/issues/668)) ([2ee4146](https://github.com/peipeimo/picpeak/commit/2ee4146d9a6fd026e7b7be3ba774de9a0cf6e96a))
* **ci:** publish v-prefixed image tags so :vX.Y.Z resolves ([#668](https://github.com/peipeimo/picpeak/issues/668)) ([784d059](https://github.com/peipeimo/picpeak/commit/784d059c3da5b36e2b6794ebf2e34bc15c8a9824))
* **ci:** publish v-prefixed image tags via type=ref,event=tag ([#668](https://github.com/peipeimo/picpeak/issues/668)) ([1f3bc3c](https://github.com/peipeimo/picpeak/commit/1f3bc3c3430414b5b6cb2141d887a8b5855a04af))
* **ci:** publish v-prefixed image tags via type=ref,event=tag ([#668](https://github.com/peipeimo/picpeak/issues/668)) ([39db7bf](https://github.com/peipeimo/picpeak/commit/39db7bf6cb5c39fcdf71c875a4aaf704f34447fa))
* **ci:** set GH_REPO in release-please auto-merge step ([0cab43e](https://github.com/peipeimo/picpeak/commit/0cab43ed898c0d080e946837894d676394805eb8))
* **ci:** whatsnew highlights — set GH_REPO so gh runs without a checkout ([3feed0f](https://github.com/peipeimo/picpeak/commit/3feed0fae6a5792a7192a529942e08d9872b7e6e))
* **ci:** whatsnew highlights — set GH_REPO so gh runs without a checkout ([2a5f0a8](https://github.com/peipeimo/picpeak/commit/2a5f0a8601ba5cb28243b39278ecdc0892388a96))
* conform moved code to eslint indent/quotes, 4-arg mutation callbacks ([2ea26a4](https://github.com/peipeimo/picpeak/commit/2ea26a49620cbe0edfbccf219696b4b386ae50d0))
* **crm:** pass trx to logActivity inside transactions — audit rows silently lost on SQLite ([#851](https://github.com/peipeimo/picpeak/issues/851)) ([a6a3c9f](https://github.com/peipeimo/picpeak/commit/a6a3c9f9f8ecb84500d5ac68e90639c362f2461a))
* **crm:** pre-event reminder passes raw event_date (fixes "Invalid Date" in the email) ([250b240](https://github.com/peipeimo/picpeak/commit/250b240337733362cb9a74b248ac78b6e9347bf7))
* **crm:** pre-event reminder resolves recipient from the event row, not a non-existent column ([5fbe514](https://github.com/peipeimo/picpeak/commit/5fbe514db6e386eee2eeade548bccbb5bbc5b422))
* **crm:** quote→event fallback resolves an ACTIVE event type, never hardcoded 'wedding' ([2309812](https://github.com/peipeimo/picpeak/commit/23098127a83fb12f6a32809666ec93eef9ac90cb))
* **dates:** normalize SQLite epoch timestamps at remaining API surfaces ([#485](https://github.com/peipeimo/picpeak/issues/485) follow-up) ([#857](https://github.com/peipeimo/picpeak/issues/857)) ([c6ec93e](https://github.com/peipeimo/picpeak/commit/c6ec93eef9f18e8867e86691800a60379bb16591))
* **deps:** bump ip-address, brace-expansion and postcss for open CVEs ([#987](https://github.com/peipeimo/picpeak/issues/987)) ([6c03fea](https://github.com/peipeimo/picpeak/commit/6c03feaef5ef9be694445728f5d5a4ddabafd5c1))
* **deps:** bump nanoid and js-yaml out of two HIGH advisories ([#1013](https://github.com/peipeimo/picpeak/issues/1013)) ([e3830cd](https://github.com/peipeimo/picpeak/commit/e3830cd9219ad4e81b556c7682e0f48a806f1620))
* **docker:** default NODE_ENV=production so non-compose deploys don't fall back to SQLite ([#1038](https://github.com/peipeimo/picpeak/issues/1038)) ([#1039](https://github.com/peipeimo/picpeak/issues/1039)) ([6de30e5](https://github.com/peipeimo/picpeak/commit/6de30e5bf17b54601e64d1b0b6a31d8877aa642d))
* **email,ui:** billing emails follow customer language + readable pay… ([ea86871](https://github.com/peipeimo/picpeak/commit/ea86871b81ed65c47e0de3332510c9a0c8343ba0))
* **email,ui:** billing emails follow customer language + readable payment-check confirmation ([0c2d319](https://github.com/peipeimo/picpeak/commit/0c2d319fc1ed67843cc60afdcaea5807ea49226f))
* **email,ui:** billing emails follow customer language + readable payment-check confirmation ([fcc3e91](https://github.com/peipeimo/picpeak/commit/fcc3e9195d6f63b2dffddfa72a867a3e32325e81))
* **email:** resolve recipient language from the queue row's event_id, not just email_data ([10559fd](https://github.com/peipeimo/picpeak/commit/10559fd68e77eb00f3dd79366fcbb7880321e6b8))
* **email:** sibling billing emails follow customer language too ([c0008be](https://github.com/peipeimo/picpeak/commit/c0008be39bc8a9d354e48ce8d6bd89662bc53ebb))
* enable release-PR auto-merge with the PAT so releases actually publish ([97b9853](https://github.com/peipeimo/picpeak/commit/97b9853709fb59a900d70bb2a6bf365d98ae4f86))
* event creation 500s on PostgreSQL (NaN slideshow seed) + stray "0" boolean renders ([b187f58](https://github.com/peipeimo/picpeak/commit/b187f588b4d12af7a7849f8558c0085573d4af76))
* event-reminder, email-language & gallery-publish bugs surfaced during workflow testing ([c8714ca](https://github.com/peipeimo/picpeak/commit/c8714ca42f4d82d50fe611b2a630260ebecbe740))
* **event-types:** harden setup window + catalog validation (codex review) ([f8ba669](https://github.com/peipeimo/picpeak/commit/f8ba6697163b4d9aa0fa0014cb5b0810371c04ae))
* **event-types:** renaming a type's slug cascades to events, quotes + reminder template ([415c93a](https://github.com/peipeimo/picpeak/commit/415c93a512f74898d0225ce2e9298f24cc12f60d))
* **event-types:** un-hardcode event type dependencies in v1 API and CRM ([d64eef8](https://github.com/peipeimo/picpeak/commit/d64eef8abf2915230b3cdd38a3bbb8af1a12c6d2))
* **event-types:** un-hardcode event type dependencies in v1 API and CRM ([#800](https://github.com/peipeimo/picpeak/issues/800)) ([5da1c3a](https://github.com/peipeimo/picpeak/commit/5da1c3a12f603a230091426b1d7be0eac83da22c))
* **events:** accept hero_logo_visible: null on create/update ([#822](https://github.com/peipeimo/picpeak/issues/822)) ([0245e44](https://github.com/peipeimo/picpeak/commit/0245e445cafd165ada3c5a15abb258ae2c1c857e))
* **events:** accept hero_logo_visible: null on create/update ([#822](https://github.com/peipeimo/picpeak/issues/822)) ([b97b130](https://github.com/peipeimo/picpeak/commit/b97b130cadebaef38e59cc227fa6578ac886110f))
* **events:** make event_date/expires_at nullable on SQLite ([#1029](https://github.com/peipeimo/picpeak/issues/1029)) ([#1035](https://github.com/peipeimo/picpeak/issues/1035)) ([671c4db](https://github.com/peipeimo/picpeak/commit/671c4dbd56fde69d512c09af2e928f1899c5ad8a))
* **events:** NaN from slideshow seed breaks event creation on PostgreSQL ([8c86518](https://github.com/peipeimo/picpeak/commit/8c86518aadae000f8e948b0cd6470730db549c1b))
* **events:** wire customer notifications into both public API entry points ([#647](https://github.com/peipeimo/picpeak/issues/647)) ([f017542](https://github.com/peipeimo/picpeak/commit/f01754247cdb94c5935ad5abbda116841f6c7fba))
* **events:** wire customer notifications into both public API entry points ([#647](https://github.com/peipeimo/picpeak/issues/647)) ([511d647](https://github.com/peipeimo/picpeak/commit/511d647eec656cd223c029a9455420fc0621cc80))
* **feedback:** persist guest feedback settings, unshadow the guest route ([#1030](https://github.com/peipeimo/picpeak/issues/1030)) ([#1031](https://github.com/peipeimo/picpeak/issues/1031)) ([89dc962](https://github.com/peipeimo/picpeak/commit/89dc9623c154493eb50f94a25da3e774e8c215b1))
* **file-watcher:** bound concurrent photo processing ([#846](https://github.com/peipeimo/picpeak/issues/846)) ([8337a71](https://github.com/peipeimo/picpeak/commit/8337a716b169e66f8edf8619c64622e6853dae81))
* **gallery:** block password form in Instagram in-app browser and unmask login errors ([#863](https://github.com/peipeimo/picpeak/issues/863)) ([323dcae](https://github.com/peipeimo/picpeak/commit/323dcae91702b8a77d2db801b63398a76f16fee2))
* **gallery:** coerce SQLite 0/1 booleans in the guest surface ([#1028](https://github.com/peipeimo/picpeak/issues/1028)) ([#1034](https://github.com/peipeimo/picpeak/issues/1034)) ([34ee311](https://github.com/peipeimo/picpeak/commit/34ee31141b0e6b93c75ea91fd6d82ca35f72eacb))
* **gallery:** don't close the lightbox when clicking beside the photo ([#883](https://github.com/peipeimo/picpeak/issues/883)) ([#890](https://github.com/peipeimo/picpeak/issues/890)) ([34c2992](https://github.com/peipeimo/picpeak/commit/34c2992521fcb4a495398f27f6044d696b4d17c3))
* **gallery:** keep the lightbox toolbar from masking the photo ([#888](https://github.com/peipeimo/picpeak/issues/888)) ([#892](https://github.com/peipeimo/picpeak/issues/892)) ([ec66cd2](https://github.com/peipeimo/picpeak/commit/ec66cd2684b5ee608f23304ec0da029f38a3eed4))
* **gallery:** publish dialog stuck for password-protected galleries with no inline email ([aa3471e](https://github.com/peipeimo/picpeak/commit/aa3471efe1629f36adeff8774dfdc379d4652e26))
* **gallery:** serve JPEG preview for non-displayable originals in lightbox (codex review of [#832](https://github.com/peipeimo/picpeak/issues/832)) ([808d305](https://github.com/peipeimo/picpeak/commit/808d3055497bb4e4a372acafa49ef9baf257f008))
* **gallery:** show feedback filter chips on desktop for galleries without categories ([0751a08](https://github.com/peipeimo/picpeak/commit/0751a08aa661a430c1609cd8c118347291cbaa14))
* **gallery:** show feedback filter chips on desktop for galleries without categories ([#802](https://github.com/peipeimo/picpeak/issues/802)) ([b928338](https://github.com/peipeimo/picpeak/commit/b9283386a57431ac8bd395347f9acb9bbdf82e8e))
* **gallery:** unbreak password entry in Instagram in-app browser ([#654](https://github.com/peipeimo/picpeak/issues/654)) ([6193ab7](https://github.com/peipeimo/picpeak/commit/6193ab7f6aafd94b6e2e432ddf170361fd306d4e))
* **gallery:** unbreak password entry in Instagram in-app browser ([#654](https://github.com/peipeimo/picpeak/issues/654)) ([b1bfd48](https://github.com/peipeimo/picpeak/commit/b1bfd4838e7104e4f85695e180b20222206073ac))
* **i18n:** replace ASCII quote with U+201D in DE perGuestLimitsDesc ([98e97e3](https://github.com/peipeimo/picpeak/commit/98e97e3cf214c96cdefd99bfedd6724f0b85c41c))
* **invoices:** add bank transfer to the mark-paid method list ([e96ef4c](https://github.com/peipeimo/picpeak/commit/e96ef4c5a35bc9e575bc3419fb318a3ee9df1bd6))
* **invoices:** badge held (unsent, no send date) invoices as "Draft" ([e4367e0](https://github.com/peipeimo/picpeak/commit/e4367e028a5228ef50c4bbd522d0777bc7340b52))
* **invoices:** correct payment-check email template key so dunning email sends ([9a76333](https://github.com/peipeimo/picpeak/commit/9a763337b658299aae0d7c985071c4a775000f99))
* **invoices:** correct payment-check email template key so dunning email sends ([3682de1](https://github.com/peipeimo/picpeak/commit/3682de195b46eae692db3ff4a1476b00d3a6e216))
* **invoices:** show "Draft" on the invoice detail page for accumulator drafts ([ca09442](https://github.com/peipeimo/picpeak/commit/ca0944293f66b6465a577340e63d592598915092))
* **invoices:** show sub-cent Rundung in the editor totals preview ([c2bc2b0](https://github.com/peipeimo/picpeak/commit/c2bc2b098e6af3e984e5b06f42e21a8d9501349b))
* **messages:** dynamic addresses, branding accent, compose/sync, per-identity SMTP ([7cc1c59](https://github.com/peipeimo/picpeak/commit/7cc1c596613c019db1e64fdc058a9e28bfd11fdc))
* **messages:** dynamic addresses, branding accent, compose/sync, per-identity SMTP ([f9c2b4e](https://github.com/peipeimo/picpeak/commit/f9c2b4ed75b8a22182226a6328be0029c54d7bc4))
* **messages:** make the Messaging feature flag toggleable ([b96ad36](https://github.com/peipeimo/picpeak/commit/b96ad36f5d65ca3774af4b6fa692b08819642de1))
* **messages:** PR [#769](https://github.com/peipeimo/picpeak/issues/769) nits — server-side search, bare-email recipient, DE i18n ([1e08a4f](https://github.com/peipeimo/picpeak/commit/1e08a4fb156d34ee8ddff69b0a7612001aa6d67e))
* **messages:** PR [#769](https://github.com/peipeimo/picpeak/issues/769) review — escape reply sender (XSS), gate backend routes, exact customer match ([bb235e7](https://github.com/peipeimo/picpeak/commit/bb235e72e58359f55f8aeccf2f22c671584fdbd7))
* **messages:** show only the mailbox local part in the sidebar (full … ([c622a35](https://github.com/peipeimo/picpeak/commit/c622a35033d739bd04fa8a5388b2670769575bf4))
* **messages:** show only the mailbox local part in the sidebar (full address on hover) ([88fe9f9](https://github.com/peipeimo/picpeak/commit/88fe9f984455ca1509f92a8b1d38342379acfd6c))
* **messages:** show the resolved customer's name in the doc-action modal ([2c5c1d5](https://github.com/peipeimo/picpeak/commit/2c5c1d561bbe567b9d7615e7c2d071d08bb6d63c))
* mirror [#734](https://github.com/peipeimo/picpeak/issues/734) onto decomposed files (PG NaN slideshow seed, SQLite bool renders) ([766351b](https://github.com/peipeimo/picpeak/commit/766351b588bb9d3b270acb1b8c64bd6e242366c2))
* **og:** broaden social-crawler coverage (Bluesky Cardyb, WeChat-scraper, fediverse, etc.) ([a0a28a4](https://github.com/peipeimo/picpeak/commit/a0a28a47777db9ca9e60a5134c8d86503c060e79))
* **og:** rich social previews for share-token + slideshow URLs ([#699](https://github.com/peipeimo/picpeak/issues/699)) ([25bf7bb](https://github.com/peipeimo/picpeak/commit/25bf7bb5239420da078749bac270196df6968581))
* **og:** rich social previews for share-token + slideshow URLs ([#699](https://github.com/peipeimo/picpeak/issues/699)) ([1b8747d](https://github.com/peipeimo/picpeak/commit/1b8747dc82763ba6b4da3a55045cab8740da2a13))
* **og:** route branded short URLs + slideshow links to OG, add Viber ([#699](https://github.com/peipeimo/picpeak/issues/699)) ([0dffe0c](https://github.com/peipeimo/picpeak/commit/0dffe0ce92339e0608b3ef660e84c31a62f4a98c))
* **og:** route branded short URLs + slideshow to OG handler, add Viber ([#699](https://github.com/peipeimo/picpeak/issues/699)) ([a87ad77](https://github.com/peipeimo/picpeak/commit/a87ad77d8d5215c88f5d95cc7aebaa1769938ec0))
* **oidc:** fail clearly when no public base URL is configured ([ac1838f](https://github.com/peipeimo/picpeak/commit/ac1838fbd7352dc55dc3d9bdebca9d1ee57ab866))
* **oidc:** local-credential lockout, session hydration, split-origin gaps (codex round 3) ([e91c7de](https://github.com/peipeimo/picpeak/commit/e91c7deaa4223051a19254b7ba78c8bb4cde06fd))
* **oidc:** security + robustness hardening from codex review rounds 1-2 ([7f7d38a](https://github.com/peipeimo/picpeak/commit/7f7d38a57ff519880a74d45065863e9cc537e488))
* **pdf:** correct multi-page invoice/quote layout + drop IBAN dup under Swiss QR ([2205b0b](https://github.com/peipeimo/picpeak/commit/2205b0bd687587ff2b54fbddb4770bf69a5ef3b2))
* **projects:** stop the cockpit offering email controls the API rejects ([#976](https://github.com/peipeimo/picpeak/issues/976)) ([67592fc](https://github.com/peipeimo/picpeak/commit/67592fc56956b1ec4db696483efd2a285bffb6f4))
* **release:** target stable in release-please + undo bogus 2.7.0 bump ([274ef0c](https://github.com/peipeimo/picpeak/commit/274ef0cd731765b057a5d62d5f41c14cb3a1564b))
* **release:** target stable in release-please.yml + undo the bogus 2.7.0 bump ([65ac6ed](https://github.com/peipeimo/picpeak/commit/65ac6eddacb79857e9a9651d3c869e7bfdd92887))
* **reminders:** wrap is_active/is_archived wheres in formatBoolean ([b9d9138](https://github.com/peipeimo/picpeak/commit/b9d91385b43de7ede508884f7cf78b5cf785f853))
* **security:** authz/ownership gaps (token binding, auth revocation, feedback/customer ownership, token logging) ([#950](https://github.com/peipeimo/picpeak/issues/950)) ([c2ce12c](https://github.com/peipeimo/picpeak/commit/c2ce12c039d5564e4457fdbbd50a06bbcfec4d6a))
* **security:** backup/restore hardening — public-dir DB dump, restore path allowlist, gunzip bound, manifest keying ([#956](https://github.com/peipeimo/picpeak/issues/956)) ([0d4c308](https://github.com/peipeimo/picpeak/commit/0d4c30884e21a43401f7e8acc0f31e5ab1f77bba))
* **security:** block guest access to hidden/client-only photos across bulk + secure routes ([#939](https://github.com/peipeimo/picpeak/issues/939)) ([8a87c92](https://github.com/peipeimo/picpeak/commit/8a87c9274b2950a500ed1d17bc30fa573fcbf0c0))
* **security:** bound inbound-mail resources, redact secrets from logs (GHSA-2qf9, pgmp, r794) ([#959](https://github.com/peipeimo/picpeak/issues/959)) ([1b4e5fe](https://github.com/peipeimo/picpeak/commit/1b4e5fee3efd1a7fb980476d45551971225df50c))
* **security:** bump backend deps to close all 14 open Trivy code-scanning alerts ([#869](https://github.com/peipeimo/picpeak/issues/869)) ([38b8d47](https://github.com/peipeimo/picpeak/commit/38b8d476d17d5a28724dbd81c79d57e23d65a2fa))
* **security:** bump sanitize-html to 2.17.5 (CVE-2026-53606) ([#937](https://github.com/peipeimo/picpeak/issues/937)) ([fe615c8](https://github.com/peipeimo/picpeak/commit/fe615c82e48de42399d8be47f796878835b90c5d))
* **security:** close 4 open security advisories (backup takeover, share-login bypass, ZIP slip, chunked-upload traversal) ([7ebc232](https://github.com/peipeimo/picpeak/commit/7ebc2326204ad0572e6a1fc121b5d232da06cec3))
* **security:** close 5 Trivy alerts — postcss/tar bumps + drop npm from the runtime image ([#878](https://github.com/peipeimo/picpeak/issues/878)) ([08be2b8](https://github.com/peipeimo/picpeak/commit/08be2b84f18073b63fa131c692c50b6df849a0ca))
* **security:** close authorization/ownership gaps (token scope, mass-assignment, category hero, project docs) ([#943](https://github.com/peipeimo/picpeak/issues/943)) ([82d6871](https://github.com/peipeimo/picpeak/commit/82d68711cf7b74b9c81a0eed3fd0905d668d5df7))
* **security:** close cross-event thumbnail leak, bulk-op ownership bypass, + hardening ([081f3ed](https://github.com/peipeimo/picpeak/commit/081f3edcdffc65a77000cc638e364ea9dc03767f))
* **security:** close GHSA-g94x (cross-gallery photo read) + GHSA-pv6w (admin DB export) ([#924](https://github.com/peipeimo/picpeak/issues/924)) ([03087c7](https://github.com/peipeimo/picpeak/commit/03087c798c8414505fcd694df7cd53bc08126b32))
* **security:** cross-event thumbnail leak, bulk-op ownership bypass + auth hardening ([b732974](https://github.com/peipeimo/picpeak/commit/b732974779803b67097c81ae6bce2de0f2910794))
* **security:** enforce event ownership on the v1 API surface (GHSA-9697) ([#957](https://github.com/peipeimo/picpeak/issues/957)) ([e2ce95e](https://github.com/peipeimo/picpeak/commit/e2ce95ee48105f6e04150334df77a866a1c60a83))
* **security:** enforce project ownership on project + project-email routes (GHSA-wrg5, GHSA-93x4) ([#960](https://github.com/peipeimo/picpeak/issues/960)) ([7c0c0a5](https://github.com/peipeimo/picpeak/commit/7c0c0a5b7ff5758ec07ac64ab5c0c81818cca96d))
* **security:** escape brand tokens, block tracker redirects, trim logo diagnostic (GHSA-j347, mw76, 29vm) ([#961](https://github.com/peipeimo/picpeak/issues/961)) ([164129b](https://github.com/peipeimo/picpeak/commit/164129b8f5bbf8a68d743930a72bdb95b88fdee3))
* **security:** harden .picpeak restore operator-preservation (GHSA-qxfx follow-up) ([38fd41a](https://github.com/peipeimo/picpeak/commit/38fd41aad3fcb12a249aaa2eb3d98fbffbde537a))
* **security:** mask backup credentials on read + unblock MFA login during maintenance ([eadf282](https://github.com/peipeimo/picpeak/commit/eadf282755829cb51e6ea37221be31d8c9af41c5))
* **security:** mask backup credentials on read + unblock MFA login during maintenance ([07f2c90](https://github.com/peipeimo/picpeak/commit/07f2c900556738e993fb63764210b541d7692c9d))
* **security:** neutralize spreadsheet formulas in all CSV/export cell-writers (CSV injection cluster) ([#948](https://github.com/peipeimo/picpeak/issues/948)) ([8f91c2c](https://github.com/peipeimo/picpeak/commit/8f91c2ca99de09d64b32a292c5f7fe86e63f9787))
* **security:** preserve current admin on .picpeak restore (GHSA-qxfx-4493-4v8f) ([348894e](https://github.com/peipeimo/picpeak/commit/348894efefa5a7b49d32feb22a98045b93076138))
* **security:** read the password-complexity key the settings UI writes ([#843](https://github.com/peipeimo/picpeak/issues/843)) ([8060fed](https://github.com/peipeimo/picpeak/commit/8060fedf6aaea5359c3bf04696fd00ec8500b51a))
* **security:** redact gallery share tokens from analytics tracking (GHSA-7m6c) ([#952](https://github.com/peipeimo/picpeak/issues/952)) ([1c8f7d5](https://github.com/peipeimo/picpeak/commit/1c8f7d58a88b867c07d8d9699c20866c334dfa73))
* **security:** reject ZIP-slip entries in archive/backup restore (GHSA-jfhw-fj23-fx6x) ([9cd6b08](https://github.com/peipeimo/picpeak/commit/9cd6b08441e8633751b9fb73daca5ca0555c950b))
* **security:** remove unguarded legacy /api/events router (GHSA-4j34-x562-5vfq) ([e7ca8bd](https://github.com/peipeimo/picpeak/commit/e7ca8bdb7f30d999039125c0f0ef89bdc92d5a69))
* **security:** remove unguarded legacy /api/events router (GHSA-4j34-x562-5vfq) ([6cd546e](https://github.com/peipeimo/picpeak/commit/6cd546e86ae38819c0fdc24044f86106503fa020))
* **security:** resolve DNS before vetting external hostnames (SSRF cluster) ([#941](https://github.com/peipeimo/picpeak/issues/941)) ([b700569](https://github.com/peipeimo/picpeak/commit/b7005692b33595cf9df52892ce2f94342ca21fe5))
* **security:** sanitize chunked-upload filename (GHSA-pc72-jf53-w28j) ([31bc01c](https://github.com/peipeimo/picpeak/commit/31bc01cb4bbf65b48b3a5c3c94ad35e487df9fcc))
* **security:** scope dashboard stats/analytics/activity to the caller's events (GHSA-c2jj, gqx7, jhcf) ([#958](https://github.com/peipeimo/picpeak/issues/958)) ([da855cf](https://github.com/peipeimo/picpeak/commit/da855cfef9e74b0b1e77d54c39008c998ab3e20b))
* **security:** share-login must not bypass gallery password (GHSA-9hmx-68vc-qpqw) ([7dace04](https://github.com/peipeimo/picpeak/commit/7dace044dcc1c3b5a13c4704510c87616632618c))
* **security:** unauth share_token leak (HIGH) + restore path-traversal, logo file-read, branding path keys ([#946](https://github.com/peipeimo/picpeak/issues/946)) ([9050aff](https://github.com/peipeimo/picpeak/commit/9050affd8dd0d5dff0514a8a7cb677fc2d410fca))
* **security:** vet the destination project when linking a deal ([#991](https://github.com/peipeimo/picpeak/issues/991)) ([0c8ad6b](https://github.com/peipeimo/picpeak/commit/0c8ad6bbedb00ba443c20c7ab00b58925d6b9b5c))
* set GH_REPO in release-please auto-merge step ([d00d52a](https://github.com/peipeimo/picpeak/commit/d00d52a2215dfcae34086cf3e10fe4da0aef09c9))
* **settings:** remove duplicate Mail import that broke the dev server ([5b535f8](https://github.com/peipeimo/picpeak/commit/5b535f86580275eda768fa2d85a8c94bd701f832))
* **settings:** remove duplicate Mail import that crashes the dev server ([4aa6583](https://github.com/peipeimo/picpeak/commit/4aa6583baef55e2c12e9cde7d391156436de518f))
* **setup:** address PR [#714](https://github.com/peipeimo/picpeak/issues/714) review — password UX, script token, race, nits ([286975d](https://github.com/peipeimo/picpeak/commit/286975dc52acf72809476e49ec0393021dd467cb))
* **setup:** keep the first-run wizard light regardless of dark mode ([d4b143f](https://github.com/peipeimo/picpeak/commit/d4b143f313d00f2a30abcbc1a880c140d7455e7b))
* **setup:** match first-run logo size to the login page default ([3e69c5d](https://github.com/peipeimo/picpeak/commit/3e69c5df3ffecc42663cba4ad7bf9f18795cedce))
* **slideshow:** deny display-only token on download/upload/feedback (PR [#646](https://github.com/peipeimo/picpeak/issues/646) review) ([e36b330](https://github.com/peipeimo/picpeak/commit/e36b3309ca66404d189d5b218cc1f0eba925e4c7))
* **slideshow:** stop "no crop" fit letterboxing a pre-cropped frame ([#1015](https://github.com/peipeimo/picpeak/issues/1015)) ([#1018](https://github.com/peipeimo/picpeak/issues/1018)) ([75bfad2](https://github.com/peipeimo/picpeak/commit/75bfad2b6ae2e7a9a622d0c648df30db83c69b14))
* sync gallery feedback filters after lightbox like/rating in simple mode ([#882](https://github.com/peipeimo/picpeak/issues/882)) ([33f1bc4](https://github.com/peipeimo/picpeak/commit/33f1bc42a9441cba4c4cef81217a3073bbfd4e8b))
* **test:** raise bootCrmDb beforeAll timeout on slideshow suites ([f4b6b89](https://github.com/peipeimo/picpeak/commit/f4b6b8941a30a20615cc87627a0663ff6d03c932))
* **tests:** raise jest timeouts to survive the growing migration chain ([#860](https://github.com/peipeimo/picpeak/issues/860)) ([40eb03f](https://github.com/peipeimo/picpeak/commit/40eb03f0d80458f6c7dc4f6e6430668451edadac))
* **tests:** raise migration-boot hook timeout pins to the 120s default ([#900](https://github.com/peipeimo/picpeak/issues/900)) ([d9ad982](https://github.com/peipeimo/picpeak/commit/d9ad982373861cd05f23167f1e2e50eaebfb7bba))
* **update:** target docker-compose.production.yml in dashboard update steps ([51a505e](https://github.com/peipeimo/picpeak/commit/51a505e3798895e544f943673e81a365265f319c))
* **update:** target docker-compose.production.yml in dashboard update steps + gate mailhog ([2a0361a](https://github.com/peipeimo/picpeak/commit/2a0361a83b4ca0a600bb4fd447e338533ce63420))
* **uploads:** allow configured raw formats ([f4b685a](https://github.com/peipeimo/picpeak/commit/f4b685a5abef8071f49540648bb3f0ae033b0c58))
* **uploads:** apply configured max file size to guest uploads ([#613](https://github.com/peipeimo/picpeak/issues/613) follow-up) ([29f1d23](https://github.com/peipeimo/picpeak/commit/29f1d23a0a645208f22453e62d99fe79b55c7db4))
* **uploads:** apply configured max file size to guest uploads ([#613](https://github.com/peipeimo/picpeak/issues/613) follow-up) ([1e38d84](https://github.com/peipeimo/picpeak/commit/1e38d84808ee2a2b176c75d5ec4975fba710e63c))
* **uploads:** apply RAW extraction in the actual async ingest path (codex review of [#833](https://github.com/peipeimo/picpeak/issues/833)) ([b743ea0](https://github.com/peipeimo/picpeak/commit/b743ea0398c7ec0178cf29107629a7877442c494))
* **uploads:** DNG magic must be a single entry (.every validation) ([e732e13](https://github.com/peipeimo/picpeak/commit/e732e13f24c71ce091c6a82895d6526a67005c98))
* **uploads:** keep videos when thumbnail generation fails ([#845](https://github.com/peipeimo/picpeak/issues/845)) ([0310c46](https://github.com/peipeimo/picpeak/commit/0310c46fdd5b03274f761abfb4c8b552e2f8b666))
* **uploads:** prevent cross-photo contamination from filename collisions and non-atomic writes ([#931](https://github.com/peipeimo/picpeak/issues/931)) ([#933](https://github.com/peipeimo/picpeak/issues/933)) ([defeae9](https://github.com/peipeimo/picpeak/commit/defeae96349e4b68a2db6d66ad68b255e98f9e3b))
* **uploads:** RAW derivative key collision, watermark skip, dev exiftool (codex review of [#833](https://github.com/peipeimo/picpeak/issues/833) round 2) ([d0ccadb](https://github.com/peipeimo/picpeak/commit/d0ccadbc99e510d124814701faa410b3099792ed))
* **uploads:** register HEIC/HEIF with the file validator + fix admin format hint (codex review of [#832](https://github.com/peipeimo/picpeak/issues/832)) ([c9b64d9](https://github.com/peipeimo/picpeak/commit/c9b64d9c1a8744c9ee5e068366a500ae0dab36bc))
* **uploads:** show configured guest file types ([433fb9a](https://github.com/peipeimo/picpeak/commit/433fb9a989ed95d961b86b075b09703dbb8ed981))
* **uploads:** support configured raw formats ([f7fd893](https://github.com/peipeimo/picpeak/commit/f7fd89387be80ea9b3b5c11d06828a4c1a0d4af5))
* **uploads:** tighten guest max-file-size setting (codex review of [#823](https://github.com/peipeimo/picpeak/issues/823)) ([43c6d22](https://github.com/peipeimo/picpeak/commit/43c6d22bdd93179865703da6350094c9b95388d8))
* **uploads:** tighten guest max-file-size setting (codex review of [#823](https://github.com/peipeimo/picpeak/issues/823)) ([e03d13e](https://github.com/peipeimo/picpeak/commit/e03d13efde843c7a7275cd41c855b402538756e7))
* **whatsapp:** admin-pinned template language + Arabic locale support ([#647](https://github.com/peipeimo/picpeak/issues/647)) ([4fd7709](https://github.com/peipeimo/picpeak/commit/4fd7709596e7a0dd3fedef63772ddd52ce5561c9))
* **whatsnew:** decode HTML entities and trim em-dash detail in fallback bullets ([5582644](https://github.com/peipeimo/picpeak/commit/5582644dc49330549be2a3a4cdd5b1ba0f21a294))
* **workflows:** backfill existing invoices + anchor dunning grace to due date when enabled ([#750](https://github.com/peipeimo/picpeak/issues/750)) ([9596342](https://github.com/peipeimo/picpeak/commit/9596342d6a9ef107193cfc123487a8061f4a91ca))
* **workflows:** backfill existing invoices + anchor grace to due date when dunning is enabled ([#750](https://github.com/peipeimo/picpeak/issues/750)) ([2c7b351](https://github.com/peipeimo/picpeak/commit/2c7b35145861557021482c0e92f573236ae2676e))
* **workflows:** close review blockers — prefetch-safe approvals + loud gate-edge failure ([98ab717](https://github.com/peipeimo/picpeak/commit/98ab717043e3fdefac0934bf8f4621d523b15e9a))
* **workflows:** dark-mode canvas + readable nodes + structured config ([1734aba](https://github.com/peipeimo/picpeak/commit/1734aba39c199c8dee1b69e9933ddf57579f9d50))
* **workflows:** defer quote.accepted/declined emit until the 15-min response window locks ([539a837](https://github.com/peipeimo/picpeak/commit/539a83711d1996dc9c262365f2c511e7bc445add))
* **workflows:** harden graph validation + refuse enabling unimplemented flows ([d927464](https://github.com/peipeimo/picpeak/commit/d927464778272bd862aa01903179672f4d47368a))
* **workflows:** held booking invoices are 'scheduled', not 'pending_delivery' — so send_document can issue them ([882cfc0](https://github.com/peipeimo/picpeak/commit/882cfc0661b02602bae91b928a46ceea754f7f29))
* **workflows:** make the dashboard pending-approvals card items clickable too ([6e20d58](https://github.com/peipeimo/picpeak/commit/6e20d58487c5e20b08e1d1b4ddd4e76f9e922a79))
* **workflows:** matchFilter strict equality + accurate comment ([dee8d40](https://github.com/peipeimo/picpeak/commit/dee8d40bb3235a908bba514a97a62d3a91a6e131))
* **workflows:** Postgres-safe id capture on workflow inserts ([cede885](https://github.com/peipeimo/picpeak/commit/cede885b04854fd667f65a19697505c0a7c52739))
* **workflows:** scope dunning backfill to its own flow via targetWorkflowId ([da3a77d](https://github.com/peipeimo/picpeak/commit/da3a77dac40a892158167aec939a1458d488a951))
* **workflows:** ship built-ins disabled for first beta + enabled-based mutex + admin sentinel ([5893ecb](https://github.com/peipeimo/picpeak/commit/5893ecb27a0365a79ec04336c5a122b31d31db0e))
* **workflows:** wire a real, SSRF-guarded webhook action (was a silent no-op) ([af7eea8](https://github.com/peipeimo/picpeak/commit/af7eea8b43e37905a79138bcde4b1026dea13050))


### Performance Improvements

* **slideshow:** cache global settings to cut /state DB reads (PR [#646](https://github.com/peipeimo/picpeak/issues/646) review) ([a995131](https://github.com/peipeimo/picpeak/commit/a995131f4266e112c96c6e8cedd5158995ebe899))


### Documentation

* branch model + migration-to-org guide + PR template ([166ef47](https://github.com/peipeimo/picpeak/commit/166ef47611a248c4d517e26d390d87d21f077ca1))
* branch model + migration-to-org guide + PR-template target hint ([d606fcd](https://github.com/peipeimo/picpeak/commit/d606fcd5a425fed3c968ec06b071a386bf558c28))
* flip README links to docs.picpeak.app + delete docs/_to-migrate ([#1000](https://github.com/peipeimo/picpeak/issues/1000) phase 3) ([#1023](https://github.com/peipeimo/picpeak/issues/1023)) ([27dedb1](https://github.com/peipeimo/picpeak/commit/27dedb13f390f956690e667d41ed532bce697eb4))
* prominent migration banner at the top of README ([14bd3e1](https://github.com/peipeimo/picpeak/commit/14bd3e1a6c6cf74378d6f316024584d8941cbcd5))
* prominent migration banner at the top of README ([#669](https://github.com/peipeimo/picpeak/issues/669)) ([5839bba](https://github.com/peipeimo/picpeak/commit/5839bba72a56cc29077f63f7daa038995fb09dfb))
* **readme:** add Pixieset to comparison + customer-accounts/CRM/accounting rows ([721f440](https://github.com/peipeimo/picpeak/commit/721f440fa6e810e26ec92d89d14497bd946bcdef))
* **readme:** clarify comparison footnotes — $0 cost caveat + Pixieset video cap ([b043963](https://github.com/peipeimo/picpeak/commit/b0439638bddba819b58d375c0f42cd4df3a837b4))
* **readme:** credit [@the-luap](https://github.com/the-luap) as creator/lead maintainer ([3528f6b](https://github.com/peipeimo/picpeak/commit/3528f6b8b7e2b537b111f7787d48459a976ef744))
* **readme:** credit [@the-luap](https://github.com/the-luap) as creator/lead maintainer ([748238e](https://github.com/peipeimo/picpeak/commit/748238e8caf198e3899954804e61a2e179058957))
* **releasing:** align stable version to main on promote (Option A) ([df5aeab](https://github.com/peipeimo/picpeak/commit/df5aeaba416726cc0123f32ddf88e4a30dc28908))
* **releasing:** align stable version to main on promote (Option A) ([5dea0c9](https://github.com/peipeimo/picpeak/commit/5dea0c969558f50833973ff742257780f5842612))
* require screenshots for UI changes in PRs ([f5b4aa7](https://github.com/peipeimo/picpeak/commit/f5b4aa7a5bc321ffbd33f1c1b92003435a7ee842))
* require screenshots for UI changes in PRs ([8ca7477](https://github.com/peipeimo/picpeak/commit/8ca74776f4d3f7be930a713afe4ac4de594adedd))
* **slideshow:** add Live Slideshow guide + README entries ([16013d1](https://github.com/peipeimo/picpeak/commit/16013d1cf9ad82ee052f905f9702feffde7b67eb))
* slim README to a lean router, stage deep content for docs-site migration ([#1001](https://github.com/peipeimo/picpeak/issues/1001)) ([ddebd50](https://github.com/peipeimo/picpeak/commit/ddebd50d3fd3750f97f13a07afb38447601e3889))
* the retired registry path freezes, it does not stop serving ([#995](https://github.com/peipeimo/picpeak/issues/995)) ([b9e4259](https://github.com/peipeimo/picpeak/commit/b9e42591f53d3e5dbee136f4ee53020461c3e2ba))
